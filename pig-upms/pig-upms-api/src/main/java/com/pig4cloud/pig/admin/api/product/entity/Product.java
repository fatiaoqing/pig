...
public class Product extends Model<Product> {
	...
	@ExcelProperty(index = 0, converter = LongNumberConverter.class)
...
//	@ExcelProperty(index = 1)
	...
	@ExcelProperty(index = 4, converter = LongNumberConverter.class)
	...
	@ExcelProperty(index = 5, converter = LongNumberConverter.class)
